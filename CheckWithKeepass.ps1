...
#//Update powershell to newest version to begin with to skip potential problems 5.1 newest for ISE and 7.3.2 For non regular shell
...
#Check wordfile for more detalied info on the setup
